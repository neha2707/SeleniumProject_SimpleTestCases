...
public class UniformRemoveCartPOM {
	
			private WebDriver driver; 
			
			public UniformRemoveCartPOM(WebDriver driver) {
				this.driver = driver; 
			...
			private WebElement RmvFrmCart; 
			
			@FindBy(xpath="//div[@id='content']//p[contains(text(),'Your shopping cart is empty!')]")
			private WebElement RmvMess; 
			
					
			public void RemoveCart() {
				this.RmvFrmCart.click();
			}
			
			public String RemoveMessage() {
				return this.RmvMess.getText();
			}
